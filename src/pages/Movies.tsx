...
export default function Movies() {
  ...
  const movies: Movie[] = [
    ...
    {
      id: '3',
      title: 'Nëna Shqiptare',
      description: 'Drama prekëse për forcën e një nëne shqiptare.',
      genre: 'Dramë',
      year: 2023,
      rating: 8.8,
      image: 'https://images.unsplash.com/photo-1489599388350-e3f95e2d26b6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
    ...
    {
      id: '4',
      title: 'Komedia e Tiranës',
      description: 'Komedi e lehtë për jetën e përditshme në kryeqytet.',
      genre: 'Komedi',
      year: 2022,
      rating: 7.5,
      image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
    ...
    {
      id: '5',
      title: 'Gjurmët e Historisë',
      description: 'Dokumentar për historinë e lashtë të Shqipërisë.',
      genre: 'Dokumentar',
      year: 2023,
      rating: 8.9,
      image: 'https://images.unsplash.com/photo-1489599388350-e3f95e2d26b6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
    ...
    {
      id: '6',
      title: 'Aventurat e Ariut',
      description: 'Animacion për fëmijë që tregon aventurat e një ariu të vogël.',
      genre: 'Animacion',
      year: 2022,
      rating: 8.1,
      image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
  ...
  const genres = ['all', 'Romantik', 'Historik', 'Dramë', 'Komedi', 'Dokumentar', 'Animacion'];
    ...
    <div className="group relative cursor-pointer transition-transform duration-300 hover:scale-105">
      <div className="relative aspect-[2/3] bg-gray-800 rounded-lg overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center p-4">
          <h4 className="text-white font-bold text-lg mb-2 text-center">{movie.title}</h4>
          <p className="text-gray-300 text-sm mb-4 text-center line-clamp-3">{movie.description}</p>
    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="pt-20 px-6">
        <div className="max-w-7xl mx-auto">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-white mb-4">Filma</h1>
            <p className="text-gray-400 text-lg">
              Zbuloni koleksionin tonë të gjerë të filmave shqiptarë
            </p>
          </div>
